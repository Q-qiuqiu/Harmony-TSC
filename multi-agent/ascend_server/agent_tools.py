...
DEFAULT_SEGMENTATION_AGENT_URL = os.environ.get(
    ...
    "http://127.0.0.1:8086/v1/sub-agents/segmentation/execute",
)
DEFAULT_SUB_AGENT_PROFILE_PATH = os.environ.get(
    "SUB_AGENT_PROFILE_PATH",
    os.path.join(REPO_ROOT, "config_files", "multi_agent_info.json"),
)
